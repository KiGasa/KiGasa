...
```
Числа идут от 1<sup>*p*</sup> + 2 <sup>*p*</sup> до + n<sup>*p*</sup>, где p - степень. Расположил функцию power выше т.к. она задействована в функции sum_p, где с помощью цикла передовал числа в power, возвращал, суммировал и так далле. 
3. Напишите функцию
